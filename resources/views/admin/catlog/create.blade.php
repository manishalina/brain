      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <div class="row">
	            	<div class="col-sm-8">Add Catalogue</div>
	            	<div class="col-sm-4 text text-right">
	            		<a href="{{ URL('catlog') }}" class="btn btn-info">List</a>
	            	</div>
            	</div>
        ...
        <div class="row">
         ...
         <form method="post" action="{{ route('catlog.update',$faq->id) }}" enctype = 'multipart/form-data'>
          ...
          @csrf
  				...
  				?>
				@else
          <form method="POST" action="{{ URL('catlog') }}" enctype = 'multipart/form-data'>
          @csrf
