...
@section('content')
  ...
  <section class="about-section-four">
    <div class="auto-container">
      ...
      <div class="sec-title centered">
        ...
        <h2>We are here to help you   <br> arrive at a <span>Right career</span></h2>
      </div>
        ...
        <div class="skills-column col-lg-6 col-md-12 col-sm-12">
          <div class="inner-column">
            ...
            <div class="text">
              ...
              <p>We are a team of highly qualified and experienced academicians, educators, analysts and psychologists.We provide scientific evalution and sector wise indepth prospects.</p>
            </div>
  ...
  <!-- Video Section -->
  <section class="video-section" style="background-image:url({{asset('assets/images/background/9.jpg')}} )">
    <div class="auto-container">
      <div class="title">Video</div>
      <h2>See how we are helpful  </h2>
      <a href="https://youtu.be/eWd42Qa7O5E" class="play-now" data-fancybox="gallery" data-caption=""><i class="icon flaticon-play-button" aria-hidden="true"></i><span class="ripple"></span></a>
    </div>
  </section>
  <!-- End Video Section -->
...
<li> We are a team of highly qualified and experienced academicians, educators, analysts and psychologists with proven success in their respective fields, providing unmatched value to students and parents decision making</li>
</ul>
</div>
<div class="column col-lg-12 col-md-12 col-sm-12">
<ul class="list-style-one">
<li>We provide scientific evaluation and sector wise in-depth prospects derived from extensive research and study.</li>
</ul>
</div>
<div class="column col-lg-12 col-md-12 col-sm-12">
<ul class="list-style-one">
<li>Ours is a holistic approach to providing parent and child a platform for comprehensive discussion on careers.</li>
</ul>
</div>
<div class="column col-lg-12 col-md-12 col-sm-12">
<ul class="list-style-one">
<li>Invest your time with us and we shall help you identify your strengths.</li>
</ul>
</div>
</div>
</div>
