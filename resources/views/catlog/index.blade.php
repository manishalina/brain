...
display:block;
    ...
    <section style="padding: 179px 0px 90px;background-image:url({{asset('assets/images/background/8.jpg')}})" class="page-title" >
      ...
      <div class="content">
        <h1>Career Catalogue <span></span></h1>
        <ul class="page-breadcrumb">
          <li><a href="./">Home</a></li>
          <li>Career Catalogue</li>
        </ul>
      </div>
        </div>
    </section>
...
<div class="row">
    <div class="col-10 mx-auto">
     <h1  style="font-size:30px; margin-bottom: 20px; border-bottom: 1px solid #bdbcbc">Career Catalogue</h1>
     ...
     <div class="price-block col-lg-12 col-md-12 col-sm-12">
                                    <div class="inner-box">
                                       ...
                                       <div class="lower-box">
                                         @if(count($faqs)>0)
                                          <ul class="price-list card-columns">
                                            @foreach($faqs as $key=>$faq)
                                            <li class=""><a href="{{URL('catlogs/'.$faq->title)}}">{{$faq->title}}</a></li>

                                            @endforeach
                                          </ul>
                                          @else
                                      <div style="font-size: 16px;color:red;text-align: center;width: 100%;">{{'No Career Catalogue Listed Yet.'}}</div>
                                      @endif
                                       </div>
                                    </div>
    </div>
